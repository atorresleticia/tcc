...
\oneandhalfspacing
\include{1-introducao/capitulo_intro}
% \include{2-DW/capitulo_dw}
% \include{3-SGBD/capitulo_sgbd}
% \include{4-NoSQL/capitulo_nosql}
\include{3-FUNDAMENTOS/capitulo_fundamentos}
\include{5-TPCH/capitulo_tpch}
\include{6-Experimento/capitulo_experimento}
\include{7-Conclusao/capitulo_conclusao}
...
\oneandhalfspacing
\include{apend/apendice2}
\include{apend/apendice3}
\include{apend/apendice4}
\include{apend/apendice5}
