...
Abadi, Madden e Ferreira \cite{abadi2006integrating} utilizam a compressão por dicionário e uma variação do algoritmo \textit{null supression} para implementar o BD C-Store. Ainda apresentam dois outros métodos utilizados por eles. O primeiro é o \textit{run-length} 
