...
colunas a partir dos registros da Figura \ref{fig:regs}, baseada na entidade \textit{funcionário} apresentada no Capítulo \ref{sgbd}.
...
\begin{figure*}[htpb]
	\centering
        \includegraphics[width=\textwidth]{row_col}
...
armazenados em banco. Considere que os registros são como mostrados na Figura \ref{fig:regs}. Esse método só analisa o predicado após a construção das tuplas. Isso não acontece na LM. 
